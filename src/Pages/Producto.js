                        ...
                        <tbody>
                            {this.state.TableItems.map((item) => (
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-info"onClick={()=>this.todavia(item.Id_Producto)}>Actualizar</button></td>
                                    <td><button type="button" class="btn btn-danger"onClick={()=>this.todavia(item.Id_Producto)}>Eliminar</button></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>       
